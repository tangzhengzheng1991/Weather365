...
+(UILabel *)lableWithFrame:(CGRect)frame textFont:(UIFont *)textFont lableText:(NSString *)textString backgroundColor:(UIColor *)backgroundColor textAliment:(NSTextAlignment)textAliment textColor:(UIColor *)textColor
{
    UILabel * aLable = [[UILabel alloc] initWithFrame:frame];
    aLable.backgroundColor = backgroundColor;
    aLable.textAlignment = textAliment;
