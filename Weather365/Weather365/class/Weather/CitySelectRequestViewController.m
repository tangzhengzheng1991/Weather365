//
//  CitySelectRequestViewController.m
//  HowFarToGo
//
//  Created by tangzhengzheng on 15/12/29.
...
@interface CitySelectRequestViewController ()
{
...
@implementation CitySelectRequestViewController
...
- (void)viewDidLoad {
    ...
    self.navigationItem.leftBarButtonItem = [[UIBarButtonItem alloc] initWithImage:leftimage style:UIBarButtonItemStyleDone target:self action:@selector(backToLastVC)];
